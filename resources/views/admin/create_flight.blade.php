            ...
            <div class="bg-white border rounded-4 shadow p-4">
                <form method="POST" action="{{ route('admin.flights.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="departure_time" id="departure_time" value="{{ old('departure_time') }}" class="form-control rounded-2" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="arrival_time" id="arrival_time" value="{{ old('arrival_time') }}" class="form-control rounded-2" required>
                        @error('arrival_time')
                        <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
