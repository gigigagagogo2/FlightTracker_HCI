    ...
    <div class="mx-auto bg-white border rounded-4 shadow-sm p-4">
        <form id="airportForm" method="POST" action="{{ route('admin.airport.update', $airport->id) }}">
            ...
            <div class="mb-3">
                ...
                <input id="country" name="country" type="text" class="form-control" placeholder="Scrivi un paese..." autocomplete="off" value="{{ $airport->country }}" required>
                <div id="country-error" class="invalid-feedback" aria-live="polite"></div>
            </div>

            <div class="mb-3">
                <label for="city" class="form-label">Città</label>
                <input type="text" id="city" name="city" class="form-control" placeholder="Scrivi una città..." autocomplete="off" value="{{ $airport->city }}" required>
            ...
            fetch("{{ route('admin.city.lookup') }}", {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        resetFields();
                        showError(cityInput, cityError, data.message || "Errore nella verifica.");
